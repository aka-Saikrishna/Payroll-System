      ...
      <div className="mt-auto">
        ...
        {hasChequePayment && (
          <div className="pt-1.5">
            <h4 className="text-[8px] font-bold text-slate-700 uppercase tracking-wider mb-1 pb-0.5 border-b border-slate-200">
              PAYMENT
            </h4>
            <div className="space-y-0.5">
              <div className="flex justify-between text-slate-600">
    ...
    <div className="min-h-screen bg-slate-100 pb-12">
      ...
      <style>{`
        ...
        @media print {
          ...
          .payslip-col .text-\\[10px\\] { font-size: 9.5px !important; }
          .payslip-col .text-\\[11px\\] { font-size: 10px !important; }
          .payslip-col .text-\\[13px\\] { font-size: 11.5px !important; }
          .payslip-col-empty {
            border: none !important;
          }
          .payslip-footer {
